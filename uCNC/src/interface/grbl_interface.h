...
#define STATUS_LASER_OVER_TEMPERATURE 60
#define STATUS_LASERTUBE_NOTFLOOD 61
...
#define EXEC_ALARM_LASER_OVER_TEMPERATURE 15
#define EXEC_ALARM_LASERTUBE_NOTFLOOD 16

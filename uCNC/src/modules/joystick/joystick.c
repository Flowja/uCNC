...
float joystick_virtual_input_2(void)
{
	static uint32_t debounce = 0;
	if (!io_get_input(JOYSTICK_Z_UP))
	{
...
static float joystick_read_axis(uint8_t index)
{
	...
	case 0:
		...
		return (float)((int16_t)io_get_analog(JOYSTICK_INPUT_0) - 2048) / 2048;
#else
	...
	case 1:
		...
		return (float)((int16_t)io_get_analog(JOYSTICK_INPUT_1) - 2048) / 2048;
#else
